...
classifier.add(get_init_conv_layer(32, 3, 2)) # ned til 198 x 110
classifier.add(get_maxpool_layer(2)) # ned til 99 x 55

classifier.add(get_conv_layer(64, 3, 2)) # ned til 97 x 53
classifier.add(get_maxpool_layer(2)) # ned til 48 x 26

classifier.add(get_conv_layer(128, 3, 2)) # ned til 46 x 24
...
create_plot(history, 'RMS32cnn_2048dense')
