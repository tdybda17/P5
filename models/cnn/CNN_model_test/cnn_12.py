...
classifier.add(getinitconvlayer(64, 4, 4))
classifier.add(getconvlayer(32, 4, 4))
classifier.add(getconvlayer(16, 4, 4))
...
classifier.add(getconvlayer(64, 4, 4))
classifier.add(getconvlayer(32, 4, 4))
classifier.add(getconvlayer(16, 4, 4))
classifier.add(getmaxpoollayer(3))
...
classifier.add(getdenselayer(32))
