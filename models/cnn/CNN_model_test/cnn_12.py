...
classifier.add(get_init_conv_layer(64, 4, 4))
classifier.add(get_conv_layer(64, 4, 4))
classifier.add(get_conv_layer(64, 4, 4))
...
classifier.add(get_conv_layer(128, 4, 4))
classifier.add(get_conv_layer(128, 4, 4))
classifier.add(get_conv_layer(128, 4, 4))
classifier.add(get_maxpool_layer(3))
...
classifier.add(get_dense_layer(32))
