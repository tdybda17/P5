...
classifier.add(get_init_conv_layer(64, 4, 3))
classifier.add(get_conv_layer(64, 4, 3))
...
classifier.add(get_conv_layer(128, 4, 3))
classifier.add(get_conv_layer(128, 4, 3))
classifier.add(get_maxpool_layer(2))

classifier.add(get_conv_layer(256, 4, 3))
classifier.add(get_conv_layer(256, 4, 3))
classifier.add(get_maxpool_layer(2))
